#!/usr/bin/env python3
"""Compute features and the global scaffold split for the HRH1 dataset.

Mirrors `models/psychiatric/drd2_activity/prepare_features.py` exactly
-- see that file for the full rationale. SPLIT_SALT is
endpoint-specific so this dataset gets its own independent split
assignment, not a reuse of DRD2's.

Usage:
    python models/psychiatric/hrh1_activity/prepare_features.py
"""
...
DATASET_CSV = ROOT / "datasets" / "processed" / "hrh1_activity_dataset.csv"
OUTPUT_NPZ = ROOT / "datasets" / "processed" / "hrh1_activity_features.npz"
OUTPUT_MANIFEST = ROOT / "datasets" / "processed" / "hrh1_activity_features_manifest.json"

SPLIT_SALT = "hrh1_activity_v1"
N_SPLIT_GROUPS = 10
