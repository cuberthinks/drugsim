...
data needed at inference time for BBB, as one versioned artifact.

Mirrors ``models/admet/cyp3a4_inhibition/10_export_inference_support.py``
exactly -- this is what makes BBB loadable through the SAME generic,
...
Usage:
    python models/psychiatric/bbb_permeability/10_export_inference_support.py
"""
...
MODEL_PATH = ROOT / "models" / "psychiatric" / "bbb_permeability" / "artifact" / "model.joblib"
