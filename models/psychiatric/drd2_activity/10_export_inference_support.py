#!/usr/bin/env python3
"""Export a compact inference-support artifact for DRD2, for live serving.

Unlike CYP2D6/BBB (classification, reusing drugsim_predict's existing
ModelBundle/conformal/AD machinery), DRD2 is a regression endpoint with
...
shipping the full `datasets/processed/drd2_activity_features.npz`
...
Usage:
    python models/psychiatric/drd2_activity/10_export_inference_support.py
"""
