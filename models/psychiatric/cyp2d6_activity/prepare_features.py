#!/usr/bin/env python3
"""Compute features and the global scaffold split for the CYP2D6 dataset.

Mirrors ``models/admet/cyp3a4_inhibition/prepare_features.py`` exactly --
...
endpoint-specific ("cyp2d6_activity_v1"), so this dataset gets its own
independent split assignment.

Usage:
    python models/psychiatric/cyp2d6_activity/prepare_features.py
"""
...
OUTPUT_NPZ = ROOT / "datasets" / "processed" / "cyp2d6_activity_features.npz"
OUTPUT_MANIFEST = ROOT / "datasets" / "processed" / "cyp2d6_activity_features_manifest.json"

SPLIT_SALT = "cyp2d6_activity_v1"
N_SPLIT_GROUPS = 10
